...
import { Bug, MapPin, Star, Clock, Shield, CheckCircle } from 'lucide-react';
...
export default function PestControlPage() {
  // Filter services for pest control category
  const pestServices = services.filter(service => service.category === 'pest-control');
      ...
      <section className="py-20 relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center space-x-2 bg-primary-500/20 backdrop-blur-sm px-4 py-2 rounded-full text-primary-400 mb-6">
            ...
            <span className="text-sm font-medium">Pest Control Services</span>
          </div>
          ...
          <p className="text-xl text-white/70 mb-8 max-w-3xl mx-auto">
            Safe and effective pest control solutions for your home and business. Our licensed professionals use advanced techniques to eliminate pests and prevent future infestations.
          </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto">
              Comprehensive pest control solutions using safe, effective methods for residential and commercial properties
            </p>
          </div>
            ...
            {[
              {
                icon: Shield,
                title: 'Safe Methods',
                description: 'We use eco-friendly, family-safe pest control methods that are effective yet harmless'
              },
              {
                icon: Clock,
                title: 'Emergency Service',
                description: 'Quick response for urgent pest problems with 24/7 emergency service availability'
              },
              {
                icon: CheckCircle,
                title: 'Long-term Solution',
                description: 'Comprehensive treatment plans that eliminate current pests and prevent future infestations'
              }
            ].map((feature, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 relative">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/70 mb-8 max-w-2xl mx-auto">
            Get connected with licensed pest control professionals in your area
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/book?category=pest-control">
