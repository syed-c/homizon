...
import { Wrench, MapPin, Star, Clock, Shield, CheckCircle } from 'lucide-react';
...
export default function ApplianceRepairsPage() {
  // Filter services for appliance repairs category
  const applianceServices = services.filter(service => service.category === 'appliance-repair');
      ...
      <div className="bg-white/5 backdrop-blur-sm border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center space-x-2 text-sm text-white/70">
            ...
            <span>/</span>
            <span className="text-white">Appliance Repairs</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-20 relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center space-x-2 bg-primary-500/20 backdrop-blur-sm px-4 py-2 rounded-full text-primary-400 mb-6">
            ...
            <span className="text-sm font-medium">Appliance Repair Services</span>
          </div>
          ...
          <p className="text-xl text-white/70 mb-8 max-w-3xl mx-auto">
            Professional repair services for all major appliances. Our certified technicians provide same-day service with genuine parts and warranty coverage.
          </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto">
              Professional repair services for all major appliances with qualified technicians and genuine parts
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'All our technicians are certified and experienced with major appliance brands'
              },
              {
                icon: Clock,
                title: 'Same-Day Service',
                description: 'Quick response times with same-day service availability across Dubai'
              },
              {
                icon: CheckCircle,
                title: 'Quality Guarantee',
                description: 'We use genuine parts and provide warranty on all repairs'
              }
            ].map((feature, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 relative">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/70 mb-8 max-w-2xl mx-auto">
            Get connected with certified appliance repair technicians in your area
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/book?category=appliance-repairs">
