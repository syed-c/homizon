...
import { Sparkles, MapPin, Star, Clock, Shield, CheckCircle } from 'lucide-react';
...
export default function CleaningServicesPage() {
  // Filter services for cleaning services category
  const cleaningServices = services.filter(service => service.category === 'deep-cleaning');
      ...
      <section className="py-20 relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/70 mb-8 max-w-3xl mx-auto">
            Professional cleaning services that transform your space. From deep home cleaning to specialized services, our trained professionals deliver exceptional results.
          </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto">
              Comprehensive cleaning solutions for homes and offices with eco-friendly products and professional techniques
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'We use safe, environmentally friendly cleaning products that are effective yet gentle'
              },
              {
                icon: Clock,
                title: 'Flexible Scheduling',
                description: 'Book cleaning services at your convenience with flexible timing options'
              },
              {
                icon: CheckCircle,
                title: 'Satisfaction Guarantee',
                description: 'We ensure complete satisfaction with our thorough cleaning standards'
              }
            ].map((feature, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 relative">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/70 mb-8 max-w-2xl mx-auto">
            Get connected with professional cleaning services in your area
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/book?category=cleaning-services">
