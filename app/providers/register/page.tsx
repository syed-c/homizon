...
export default function ProviderRegisterPage() {
  ...
  console.log("Provider registration page loaded");
  ...
  const handleSubmit = () => {
    ...
    alert("Registration submitted! We'll review your application and get back to you within 24 hours.");
  };
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/70 mb-8 max-w-3xl mx-auto leading-relaxed">
              Connect with thousands of customers across Dubai. Start your journey as a verified 
              service provider and grow your business with ServiceDubai.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div className="text-center">
                ...
                <p className="text-white/60 text-sm">Access to premium customers across all Dubai areas</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-white mb-2">Flexible Schedule</h3>
                <p className="text-white/60 text-sm">Work on your own terms and set your own rates</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-white mb-2">Verified Platform</h3>
                <p className="text-white/60 text-sm">Join a trusted platform with quality assurance</p>
              </div>
            </div>
          </motion.div>
        </div>
              ...
              <div key={step.number} className="flex items-center">
                ...
                {index < steps.length - 1 && (
                  <div className={`w-16 h-1 mx-4 ${
                    currentStep > step.number ? 'bg-gradient-to-r from-primary-500 to-accent-500' : 'bg-white/20'
                  }`} />
                )}
              </div>
            ))}
              ...
              {currentStep === 1 && (
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <Select 
                      value={formData.personalInfo.experience.toString()} 
                      onValueChange={(value) => setFormData(prev => ({
                        ...prev,
                        personalInfo: { ...prev.personalInfo, experience: parseInt(value) }
                      }))}
                    >
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="w-20 h-20 bg-white/10 rounded-full flex items-center justify-center border-2 border-dashed border-white/30">
                          ...
                          <div key={serviceId} className="space-y-2">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <Input
                                type="number"
                                placeholder="0"
                                value={formData.pricing[serviceId] || ''}
                                onChange={(e) => setFormData(prev => ({
                                  ...prev,
                                  pricing: { 
                                    ...prev.pricing, 
                                    [serviceId]: parseInt(e.target.value) || 0 
                                  }
                                }))}
                                className="bg-white/10 border-white/20 text-white placeholder-white/50"
                              />
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center space-x-3">
                        <Checkbox
                          id="emergency"
                          checked={formData.availability.emergency}
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-white/5 rounded-lg p-4">
                      ...
                      {formData.personalInfo.company && (
                        <p className="text-white/70">Company: {formData.personalInfo.company}</p>
                      )}
                    </div>
                  ...
                  <div className="bg-primary-500/10 border border-primary-500/30 rounded-lg p-4">
                    ...
                    <ul className="text-white/70 space-y-1 text-sm">
                      ...
                      <li>• Once approved, you'll get access to your provider dashboard</li>
                      <li>• You can start receiving and responding to customer requests</li>
                    </ul>
                  </div>
                </div>
              )}
